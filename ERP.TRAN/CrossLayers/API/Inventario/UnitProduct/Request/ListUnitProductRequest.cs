...
{/// <summary>
 ...
 /// </remarks>
    ...
    {
        OrderBy = $"{nameof(UnitProductDetailDto.Id)} desc";
    }
    ...
    public override bool ParametersAreValid(out string? errors)
    {
        ...
        if (!string.IsNullOrWhiteSpace(OrderBy))
        {
            var validFields = new[]
            {
            nameof(UnitProductDetailDto.Id),
            nameof(UnitProductDetailDto.productName),
            nameof(UnitProductDetailDto.ProductoCodigo),
            nameof(UnitProductDetailDto.PrecioVenta)
        };
