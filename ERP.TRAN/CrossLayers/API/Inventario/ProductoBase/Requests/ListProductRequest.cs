...
{
    public sealed class ListProductRequest : BaseListRequest, IValidatableRequest
    {
        /// <summary>
        ...
        {
            OrderBy = $"{nameof(ProductoSummaryDto.Id)} desc";
        }
        ...
        public ListProductRequest(int pageNumber, int pageSize,
        ...
        public override bool ParametersAreValid(out string? errors)
        {
            ...
            if (!string.IsNullOrWhiteSpace(OrderBy))
            {
                var validFields = new[]
                {
            nameof(ProductoSummaryDto.Id),
            nameof(ProductoSummaryDto.Nombre),
            nameof(ProductoSummaryDto.Codigo),
            nameof(ProductoSummaryDto.PrecioVenta)
        };
